 ...
 */
dessert_cb_result_t dessert_mesh_ping(dessert_msg_t* msg, uint32_t len, dessert_msg_proc_t* proc, dessert_meshif_t* meshif, dessert_frameid_t id) {
    dessert_ext_t* ext;
    struct ether_header* l25h;
 ...
 * @retval DESSERT_MSG_KEEP if some other host is the destination
 */
dessert_cb_result_t dessert_mesh_pong(dessert_msg_t* msg, uint32_t len, dessert_msg_proc_t* proc, dessert_meshif_t* meshif, dessert_frameid_t id) {
    dessert_ext_t* ext;
    struct ether_header* l25h;
