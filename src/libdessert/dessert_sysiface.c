...
static dessert_cb_result_t _dessert_sysif_init_getmachack(dessert_msg_t* msg, uint32_t len, dessert_msg_proc_t* proc, dessert_sysif_t* sysif, dessert_frameid_t id);
